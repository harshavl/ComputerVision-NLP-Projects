...
from module.object_detection.helpers import sliding_window
from module.object_detection.helpers import pyramid
import argparse
import time
import cv2
...
for layer in pyramid(image, scale=args["scale"]):
	...
	for (x, y, window) in sliding_window(layer, stepSize=test_step_size , windowSize=(winW, winH)):
